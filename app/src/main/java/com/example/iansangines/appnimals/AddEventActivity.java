...
public class AddEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventSpinner = (Spinner) findViewById(R.id.notiftime);

        remainder = (CheckBox) findViewById(R.id.checkBox);
    ...
    /*    ArrayAdapter<String> timeAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, android.R.id.text1);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getId() == R.id.confevent) {
                    ...
                    if (veterniari.isChecked())
                        eventToInsert.setEventType(veterniari.getText().toString());
                    else if (vacunacio.isChecked())
                        eventToInsert.setEventType(vacunacio.getText().toString());
                    else if (desp.isChecked())
                        eventToInsert.setEventType(desp.getText().toString());
